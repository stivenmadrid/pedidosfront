    ...
    <div class="flex-container">
      <div class="card text-center">
        <div class="card-body">
          ...
          <p class="card-text">Haz clic en el siguiente botón para crear un pedido sin asignar a una mesa.</p>
      ...
      <div class="card text-center">
        <div class="card-body">
          ...
          <p class="card-text">Haz clic en el siguiente botón para crear un pedido asignado a una mesa.</p>
    ...
    <div v-if="showModalConMesa" class="modal-background" @click="cerrarModalConMesa">
      <div class="modal-content" @click.stop>
        ...
        <form @submit.prevent="crearPedidoConMesa">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(producto, index) in nuevoPedidoConMesa.productos" :key="index">
                      ...
                      <td>
                        <button type="button" class="btn btn-danger" @click="eliminarProductoConMesa(index)">Eliminar</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="field">
            <div class="control">
              <button type="button" class="btn btn-primary" @click="agregarProductoConMesa">Agregar Producto</button>
            </div>
          </div>
          <div class="field">
      ...
      <div class="modal-content" @click.stop>
        ...
        <form @submit.prevent="crearPedidoSinMesa">
          <div class="field">
            ...
            <div class="control">
              <input v-model="nuevoPedidoSinMesa.cliente" class="form-control" type="text" placeholder="Nombre del cliente" required>
            </div>
          </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(producto, index) in nuevoPedidoSinMesa.productos" :key="index">
                      <td>
                        <select v-model="producto.id" @change="actualizarTotalSinMesa" required class="form-control">
                          <option value="" disabled selected>Seleccione un producto</option>
                          <option v-for="producto in productos" :value="producto.id">{{ producto.nombre }}</option>
                        </select>
                      </td>
                      <td>
                        <input v-model="producto.cantidad" class="form-control" type="number" placeholder="Cantidad" @input="actualizarTotalSinMesa" required>
                      </td>
                      <td>
                        <input v-model="producto.observaciones" class="form-control" type="text" placeholder="Observaciones">
                      </td>
                      <td>
                        <button type="button" class="btn btn-danger" @click="eliminarProductoSinMesa(index)">Eliminar</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="field">
            <div class="control">
              <button type="button" class="btn btn-primary" @click="agregarProductoSinMesa">Agregar Producto</button>
            </div>
          </div>
          <div class="field">
            <label class="label">Total a pagar:</label>
