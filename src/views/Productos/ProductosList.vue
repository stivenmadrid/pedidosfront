            ...
            <div class="field">
              ...
              <div class="control">
                <select v-model="nuevoProducto.categoria_id" class="form-control" required>
                  <option v-for="categoria in categorias" :key="categoria.id" :value="categoria.id">{{ categoria.Nombre_Categoria }}</option>
                </select>
              </div>
            </div>
            <div class="field">
        ...
        <div class="box">
          ...
          <form @submit.prevent="editarProducto">
            ...
            <div class="field">
              <label class="label">Descripción</label>
              <div class="control">
                <input v-model="productoSeleccionado.descripcion" class="form-control" type="text" required>
              </div>
            </div>
            <div class="field">
              <label class="label">Precio</label>
