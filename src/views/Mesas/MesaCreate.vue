        ...
        <div class="box">
          ...
          <form @submit.prevent="editarMesa">
            ...
            <div class="field">
              <label class="label">Capacidad</label>
              <div class="control">
                <input v-model="mesaSeleccionada.capacidad" class="form-control" type="number" required>
              </div>
            </div>
            <div class="field">
              <label class="label">Estado</label>
            ...
            <div class="field">
              <label class="label">Descripción</label>
              <div class="control">
                <textarea v-model="mesaSeleccionada.Descripcion" class="form-control" required></textarea>
              </div>
            </div>
            <div class="field">
              <div class="control">
...
export default {
  ...
  methods: {
    ...
    editarMesa() {
      ...
      axios
        .put(`http://127.0.0.1:8000/api/v1/Mesas/update/${this.mesaSeleccionada.id}`, this.mesaSeleccionada, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        })
...
.container-fluid {  
  ...
  background-color: rgba(0, 0, 0, 0.5); /* Hacer el fondo ligeramente más oscuro para realzar los elementos más claros */
...
.scrollable-container::-webkit-scrollbar-thumb {
  background-color: rgba(255, 255, 255, 0.1); /* Hacer la barra de desplazamiento un poco visible para navegadores webkit */
}
